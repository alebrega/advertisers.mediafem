...
/*
  ...
  |--------------------------------------------------------------------------
 */
$config['website_name'] = 'Anunciantes MediaFem';
...
if ($_SERVER['HTTP_USER_AGENT']=='testMediaFem') {
...
/*
  $config['recaptcha_public_key'] = '6LcWZcUSAAAAAH-il2y537TRKyIK8t2H8_BgOVgU';
  $config['recaptcha_private_key'] = '6LcWZcUSAAAAACY_WS94CJs_lLB7jygxufEtiYTt';
 */
$config['recaptcha_public_key'] = '6LfgEdcSAAAAAIr-vgNEH3NlSQoNkGLsmr_DTCLw';
$config['recaptcha_private_key'] = '6LfgEdcSAAAAANPSjyC7B0fkpB1hI1WOhzsViP82';
