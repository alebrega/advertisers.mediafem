...
class Micuenta extends CI_Controller {
    ...
    function guardar_transaccion_mercadopago($collection_id, $collection_status, $monto) {
        if ($this->user_data->country == 'MX') {
            $currency_type = 'MXN';
        } else if ($this->user_data->country == 'AR') {
            $currency_type = 'ARS';
    ...
    function success_paypal($id_anunciante) {
        //$id_anunciante = $this->tank_auth->get_user_id();
    ...
    function obtener_historial_pagos_y_limite_de_compra($seconds) {
