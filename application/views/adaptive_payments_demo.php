<html>
    ...
    <body>
        ...
        <p><a href="http://www.angelleye.com"><img src="/images/logo.jpg" alt="Angell EYE Web Solutions Made Easy" width="500" height="102" border="0"></a></p>
        ...
        <p><?php highlight_file($_SERVER['DOCUMENT_ROOT'] . '/includes/convert_currency.php'); ?></p>
        <p><a href="/paypal/adaptive_payments/convert_currency" target="_blank">Run the code above and see the output.</a></p>
        <h2>Pay (Chained)</h2>
        ...
        <p>
            <?php highlight_file($_SERVER['DOCUMENT_ROOT'] . '/includes/pay_chained_demo.php'); ?>
        </p>
        <p><a href="/paypal/adaptive_payments/pay_chained_demo" target="_blank">Run the code above and see the output.</a></p>
        <p>&nbsp;</p>
    </body>
</html>