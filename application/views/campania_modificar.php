...
<?php } ?>
        ...
        $('#guardar_cambios').click(function(){
            ...
            var segmentacion_modificar_<?= $id_campania ?> = $('#cmb_segmentaciones_modificar_<?= $id_campania ?>').find(':selected').val();
            ...
            var form_data = {
                ...
                segmentacion: segmentacion_modificar_<?= $id_campania ?>
            };
            
            $.ajax({
                type: "POST",
                url: "/campania/valor_minimo/<?= ($empresa_campania) ? 'adtk' : 'mf' ?>",
                data: form_data,
                dataType: "json",
                success: function(msg){
                    ...
                    var device_desktop_modificar_<?= $id_campania ?> = 0;
                    var device_tablet_modificar_<?= $id_campania ?> = 0;
                    var device_phone_modificar_<?= $id_campania ?> = 0;
            
                    if($('#device_desktop_modificar_<?= $id_campania ?>').is(":checked")){
                        device_desktop_modificar_<?= $id_campania ?> = 1;
                    }

                    if($('#device_tablet_modificar_<?= $id_campania ?>').is(":checked")){
                        device_tablet_modificar_<?= $id_campania ?> = 1;
                    }
            
                    if($('#device_phone_modificar_<?= $id_campania ?>').is(":checked")){
                        device_phone_modificar_<?= $id_campania ?> = 1;
                    }
                    ...
                    var form_data2 = {
                        ...
                        fecha_fin: fecha_fin,
                        segmentacion: segmentacion_modificar_<?= $id_campania ?>,
                        frecuencia: frecuencia_modificar_<?= $id_campania ?>,
                        ...
                        device_desktop: device_desktop_modificar_<?= $id_campania ?>,
                        device_tablet: device_tablet_modificar_<?= $id_campania ?>,
                        device_phone: device_phone_modificar_<?= $id_campania ?>
                    };
...
<div class="row">
    <div class="row border_bottom">
        ...
        <select name="segmentacion_modificar_<?= $id_campania ?>" id="cmb_segmentaciones_modificar_<?= $id_campania ?>">
            <?php
        ...
        <span id="loader_segmentaciones_modificar_<?= $id_campania ?>" style="display:none"><img src="/images/ajax-loader.gif" height="10px" /></span>
        <span id="loader_cmb_sitios_modificar_<?= $id_campania ?>" style="display:none"><img src="/images/ajax-loader.gif" height="10px" />
            Cargando sitios, por favor espere
        </span>
        <span class="msg_error" style="display:none;" id="error_segmentacion_modificar_<?= $id_campania ?>"></span>
    </div>

    <table id="canales_tematicos_modificar_<?= $id_campania ?>" style="display:none;margin-bottom:25px;margin-left:165px;">
        <?php
        $i = 0;
        foreach ($canales_tematicos as $categorie) {
            ...
            if ($i == 3) {
                ?>
                <tr>
                    <td><input type="checkbox" name="chk_canales_tematicos_modificar_<?= $id_campania ?>[]" value="<?= $categorie->id ?>" <?= $selected ?> />&nbsp;<?= $categorie->nombre ?></td>
                    <?php
                    $i = 1;
                } elseif ($i == 0 || $i == 1) {
                    ?>
    ...
    <table cellpadding="0px" id="sitios_especificos_modificar_<?= $id_campania ?>" style="display:none;margin-bottom:25px;margin-left:165px;">
        <tr>
            <td colspan="3">
                Buscar: <input size="23" type="text" id="txt_sitios_web_modificar_<?= $id_campania ?>" name="q" disabled="disabled" style="width:143px !important; margin-bottom:5px;" />
                <span id="loader_comprobar_sitios_modificar_<?= $id_campania ?>" style="display:none"><img src="/images/ajax-loader.gif" /> Comprobando...</span>
            </td>
        </tr>
        <tr>
            <td style="width: 200px">
                <select style="width:201px;height:170px;" size="10" id="cmb_sitios_modificar_<?= $id_campania ?>" name="cmb_sitios_modificar_<?= $id_campania ?>" disabled="disabled" multiple="multiple">
                </select>
            </td>
            <td style="width: 10px; vertical-align: middle !important; padding:0 10px;">
                <table>
                    <tr>
                        <td><input type="button" value=">>" id="btn_pasar_sitio_modificar_<?= $id_campania ?>" disabled="disabled" class="button_new" /></td>
                    </tr>
                    <tr>
                        <td><input type="button" value="<<" id="btn_borrar_sitio_modificar_<?= $id_campania ?>" disabled="disabled" class="button_new" /></td>
                    </tr>
                </table>
            </td>
            <td>
                <select style="width:200px;height:170px;" size="10" id="cmb_sitios_2_modificar_<?= $id_campania ?>" name="cmb_sitios_2_modificar_<?= $id_campania ?>" disabled="disabled" multiple="multiple">
                    <?php
    ...
    <div class="row">
        ...
        <select name="frecuencia" id="cmb_frecuencia_modificar_<?= $id_campania ?>">
            <option value="NORMAL" data-multiplicacion="1" <?php
                    if ($frecuencia == 'NORMAL') {
                        echo 'selected="selected"';
                    }
                    ?> >Optimizada</option>
            <option value="1x24" data-multiplicacion="2" <?php
                    if ($frecuencia == '1x24') {
                        echo 'selected="selected"';
                    }
                    ?> >1 impresi&oacute;n cada 24 horas</option>
            <option value="2x24" data-multiplicacion="3" <?php
                    if ($frecuencia == '2x24') {
                        echo 'selected="selected"';
                    }
                    ?> >2 impresi&oacute;nes cada 24 horas</option>
        </select>
    </div>    
    ...
    <div class="row">
        ...
        <input type="checkbox" name="device_desktop_modificar_<?= $id_campania ?>" id="device_desktop_modificar_<?= $id_campania ?>" value="1" <?php
                    if ($campania->device_desktop == 1) {
                        echo 'checked="checked"';
                    }
                    ?> /> Desktops & Laptops
        <input type="checkbox" name="device_tablet_modificar_<?= $id_campania ?>" id="device_tablet_modificar_<?= $id_campania ?>" value="1" <?php
               if ($campania->device_tablet == 1) {
                   echo 'checked="checked"';
               }
                    ?> /> Tablets
        <input type="checkbox" name="device_phone_modificar_<?= $id_campania ?>" id="device_phone_modificar_<?= $id_campania ?>" value="1" <?php
               if ($campania->device_phone == 1) {
                   echo 'checked="checked"';
               }
                    ?> /> Phones
    </div>
