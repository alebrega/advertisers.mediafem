...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#btn_ejecutar_reporte_" + <?= $id_lineItem_appnexus ?>).click();
        ...
        var estado_opciones_avanzadas_<?= $id_lineItem_appnexus ?> = 0; // 0: mostrandose, 1: oculto;

        $("#cmb_range_<?= $id_lineItem_appnexus ?>").change(function(){
            var range = $("#cmb_range_<?= $id_lineItem_appnexus ?>").find(':selected').val();

            if(range=='especific'){
                $("#div_fechas_especificas_<?= $id_lineItem_appnexus ?>").css("display", "block");
            }else{
                $("#div_fechas_especificas_<?= $id_lineItem_appnexus ?>").css("display", "none");
            }
        });

        /*
        var timer = setTimeout("$('#esperando_<?= $id_lineItem_appnexus ?>').show();", 10000);
        $("#tbl_reporte_" + <?= $id_lineItem_appnexus ?>).append(divLoader).load('/welcome/obtener_reporte_dinamico_status/<?= $id_lineItem_appnexus ?>/APPNEXUS', function(){
            clearTimeout(timer);
        ...
        $("#btn_ejecutar_reporte_" + <?= $id_lineItem_appnexus ?>).click(function(){
            ...
            estado_opciones_avanzadas_<?= $id_lineItem_appnexus ?> = 1;
            $('#opciones_avanzadas_<?= $id_lineItem_appnexus ?>').click();
            ...
            if(por_sitio == "1"){
                $("#cargar_grafico_appnexus_" + <?= $id_lineItem_appnexus ?>).load('/welcome/obtener_reporte_dinamico_para_grafico_appnexus/'+adv_id+'/'+rango+'/'+filtros_li+'/'+grupos+'/'+columnas+'/'+fecha_desde+'/'+fecha_hasta+'/'+filtros_paises+'/'+filtros_cr+'/'+filtros_sizes+'/'+intervalo+'/'+timezone+'/'+orden+'/'+direccion+'/'+seconds+'/'+orden_id+'/1', function(){
                ...
                $("#cargar_grafico_appnexus_" + <?= $id_lineItem_appnexus ?>).load('/welcome/obtener_reporte_dinamico_para_grafico_appnexus/'+adv_id+'/'+rango+'/'+filtros_li+'/'+grupos+'/'+columnas+'/'+fecha_desde+'/'+fecha_hasta+'/'+filtros_paises+'/'+filtros_cr+'/'+filtros_sizes+'/'+intervalo+'/'+timezone+'/'+orden+'/'+direccion+'/'+seconds+'/'+orden_id, function(){
        ...
        $("#chk_sitio_<?= $id_lineItem_appnexus ?>").change(function(){
            ...
            if(thisCheck.is(':checked')){
                ...
                <?php if ($segmentacion != 3) { ?>
                    ...
                    if($("#chk_formato_<?= $id_lineItem_appnexus ?>").attr("checked"))
                    $("#chk_formato_<?= $id_lineItem_appnexus ?>").attr("checked", false);

                    if($("#chk_pais_<?= $id_lineItem_appnexus ?>").attr("checked"))
                    $("#chk_pais_<?= $id_lineItem_appnexus ?>").attr("checked", false);
                <?php } ?>
        ...
        $("#chk_formato_<?= $id_lineItem_appnexus ?>").change(function(){
            var thisCheck = $(this);
            if(thisCheck.is(':checked'))
            {
                <?php if ($segmentacion != 3) { ?>
        ...
        $("#chk_pais_<?= $id_lineItem_appnexus ?>").change(function(){
            var thisCheck = $(this);
            if(thisCheck.is(':checked'))
            {
                <?php if ($segmentacion != 3) { ?>
        ...
        $('#opciones_avanzadas_<?= $id_lineItem_appnexus ?>').click(function(){
            if(estado_opciones_avanzadas_<?= $id_lineItem_appnexus ?> == 0){
                estado_opciones_avanzadas_<?= $id_lineItem_appnexus ?> = 1;
                $('#panel_opciones_avanzadas_<?= $id_lineItem_appnexus ?>').fadeIn(800);
                $(this).html('[-] Opciones avanzadas');
            }else{
                estado_opciones_avanzadas_<?= $id_lineItem_appnexus ?> = 0;
                $('#panel_opciones_avanzadas_<?= $id_lineItem_appnexus ?>').fadeOut(400);
                $(this).html('[+] Opciones avanzadas');
            }
        });
...
<body class="ex_highlight_row">
    ...
    <input type="hidden" id="name_orden_adserver_<?= $id_lineItem_appnexus ?>" value="<?= $order_dfp ?>" />
    <input type="hidden" id="empresa_campania_orden_home_<?= $id_lineItem_appnexus ?>" value="<?= $campania->empresa_campania ?>" />
    ...
    <div style="overflow:hidden;">
        <div class="floatLeft" style="padding-right: 15px; border-right: 1px solid #eee; margin-right: 15px;">
            <b>Rango</b>
            ...
            <div id="div_fechas_especificas_<?= $id_lineItem_appnexus ?>" style="padding:20px 0 20px 47px; display: none;">
        ...
        <a href="javascript:;" id="opciones_avanzadas_<?= $id_lineItem_appnexus ?>" style="padding-top:2px; display:inline-block;">[+] Opciones avanzadas</a>
    </div>

    <hr />

    <div id="panel_opciones_avanzadas_<?= $id_lineItem_appnexus ?>" style="display: none;">
        ...
        <table class="tabla" cellspacing="30" width="100%">
            ...
            <tr>
                ...
                <td style="width: 35%;border-right: 6px solid #FFF;padding: 6px 4px;">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td id="td_size_<?= $id_lineItem_appnexus ?>" style="color:#99BC99;width: 55%;">Todos</td>
                ...
                <td style="width: 15%;border-right: 6px solid #FFF;"><input class="chk_intervalo_<?= $id_lineItem_appnexus ?>" type="checkbox" value="day" checked="checked" name="chk_intervalo_<?= $id_lineItem_appnexus ?>[]" id="chk_dia_<?= $id_lineItem_appnexus ?>" />D&iacute;a</td>
            </tr>
            ...
            <tr>
                ...
                <td id="td_chk_convs" style="border-right: 6px solid #FFF"><input type="checkbox" value="total_convs" name="chk_columnas_<?= $id_lineItem_appnexus ?>[]" id="chk_convs_<?= $id_lineItem_appnexus ?>" />Acciones</td>
            ...
            <tr>
                    ...
                    <?php if ($mostrar_filtro_pais) { ?>
                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                            <tr>
                                ...
                                <td id="td_pais_<?= $id_lineItem_appnexus ?>" style="color:#99BC99;width: 55%;">Todos</td>
                                <td style="text-align: right; width: 10%">
                ...
                <td>
                    <?php if ($agrupar_por_sitio) { ?>
                        <input type="checkbox" value="site_name" name="chk_grupos_<?= $id_lineItem_appnexus ?>[]" id="chk_sitio_<?= $id_lineItem_appnexus ?>"/>
        ...
        <div style="display: none;">
            <div id="div_filtro_line_items_<?= $id_lineItem_appnexus ?>" style="width:470px !important;height:295px !important;overflow:auto;">
                ...
                <table class="tabla_interior">
                    <tr>
                        <td><input type="button" value="Agregar todos >>>" id="btn_pasar_line_items_1_<?= $id_lineItem_appnexus ?>"/></td>
                        <td>&nbsp;</td>
                        <td style="text-align: right;"><input type="button" value="<<< Quitar todos" id="btn_pasar_line_items_2_<?= $id_lineItem_appnexus ?>"/></td>
                    </tr>
                    <tr>
        ...
        <div style="display: none;">
            <div id="div_filtro_creatives_<?= $id_lineItem_appnexus ?>" style="width:585px !important;height:305px !important;overflow:auto;">
                ...
                <table class="tabla_interior">
                    <tr>
                        <td><input type="button" value="Agregar todos >>>" id="btn_pasar_creatives_1_<?= $id_lineItem_appnexus ?>"/></td>
                        <td>&nbsp;</td>
                        <td style="text-align: right;"><input type="button" value="<<< Quitar todos" id="btn_pasar_creatives_2_<?= $id_lineItem_appnexus ?>"/></td>
                    </tr>
                    <tr>
                        <td id="tbl_creatives">
        ...
        <div style="display: none;">
            <div id="div_filtro_paises_<?= $id_lineItem_appnexus ?>" style="width:485px;height:305px;overflow:auto;">
                ...
                <table class="tabla_interior">
                    <tr>
                        <td><input type="button" value="Agregar todos >>>" id="btn_pasar_paises_1_<?= $id_lineItem_appnexus ?>"/></td>
                        <td>&nbsp;</td>
                        <td style="text-align: right;"><input type="button" value="<<< Quitar todos" id="btn_pasar_paises_2_<?= $id_lineItem_appnexus ?>"/></td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div style="display: none;">
            <div id="div_filtro_sizes_<?= $id_lineItem_appnexus ?>" style="width:480px;height:305px;overflow:auto;">
                ...
                <table class="tabla_interior">
                    <tr>
                        <td><input type="button" value="Agregar todos >>>" id="btn_pasar_sizes_1_<?= $id_lineItem_appnexus ?>"/></td>
                        <td>&nbsp;</td>
                        <td style="text-align: right;"><input type="button" value="<<< Quitar todos" id="btn_pasar_sizes_2_<?= $id_lineItem_appnexus ?>"/></td>
                    </tr>
                    <tr>
                        <td>
    ...
    <div id="cargar_grafico_appnexus_<?= $id_lineItem_appnexus ?>"></div>
