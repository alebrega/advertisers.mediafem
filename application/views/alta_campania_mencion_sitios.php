...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function btn_paso_2() {
            ...
            $.ajax({
                type: "POST",
                url: "/campania/insertar_mencion_sitios_primer_paso/",
                data: form_data,
                dataType: "json",
        ...
        $('#btn_paso_3').click(function(e) {
            ...
            var url_sitio = $("#txt_url_sitio").val();
            ...
            $.ajax({
                type: "POST",
                url: "/campania/insertar_mencion_sitios_segundo_paso/",
                data: form_data,
                dataType: "json",
                success: function(msg) {
                    if (msg.validate) {
        ...
        $('#btn_paso_4').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "/campania/insertar_mencion_sitios_tercer_paso/",
                data: form_data,
                dataType: "json",
                success: function(msg) {
                    if (msg.validate) {
...
<div id="pasos">
    ...
    <span class="div_paso_2 activo">Datos de la campa&ntilde;a (menci&oacute;n)</span>
    <span class="div_paso_3">Segmentaci&oacute;n</span>
    <span class="div_paso_4">Inversi&oacute;n</span>
    <span class="div_paso_5">Contenido</span>
...
<div id="paso_3" style="display:none;">
    ...
    <div class="row">
        <b>Por favor ingrese la URL del sitio.</b>
    </div>

    <div class="row">
        <div id="nombre_embajadora">
            URL del Sitio: <input type="text" name="txt_url_sitio" id="txt_url_sitio" value="" placeholder="Ingrese la URL" />
