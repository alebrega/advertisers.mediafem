...
?>
        ...
        function filtro_reportes(){
            ...
            if($("#cmb_canales_tematicos_2 option").length == 0){
                $('#buscar_canal').val( '' );
                $('#buscar_canal').keyup();
            }
        ...
        // REPORTE POR USUARIOS UNICOS***********************************************
        $("#btn_ejecutar_reporte_x_usuarios_unicos").click( function (){
            cargando(1);
            var tipo_de_reporte = 6;
            var form_data = {
                tipo_de_reporte : tipo_de_reporte
            ...
            tipo_reporte_solicitado = 'por_usuarios_unicos';
            ...
            $('#tbl_reporte').load('/inventario/reporte_usuarios_unicos/' + seconds, function(){
        cargando(0);
            });
        });

        mensajeGeneral('warning', 'Puedes obtener mas información de los sitios que pertenecen a MediaFem comunicandote con el representante oficial de tu país. <a href="mailto:argaccount@mediafem.com">Consultar representante</a>', 300000);
...
<table cellpadding="0px" class="tabla" width="80%" style="margin-bottom: 30px">
    ...
    <tr>
        <td colspan="5">
            <?php
                if($this->user_data->representante_oficial){
            ?>
            ...
            <!--
            <input type="button" class="button_new" value="Por Usuarios unicos" id="btn_ejecutar_reporte_x_usuarios_unicos" />
            -->
