...
<table CELLPADDING="0px" CELLSPACING="0px" border="1">
    ...
    foreach ($data_tabla as $row) {
        ...
        <tr>
            ...
            for ($i = 0; $i < count($columnas); $i++) {
                ?>
            <td style="<?= $color ?>;text-align: left"><?= utf8_encode($row[$columnas[$i]]); ?></td>
                <?php
            }
            ?>
        </tr>
    ...
    <tr style="font-weight:bold;">
        ...
        for ($i = 0; $i < count($columnas); $i++) {
            if ($columnas[$i] == "Clicks") {
                ?>
                <td style="background-color: #E5E5E5;text-align: left"><?= number_format($total_clicks, 0, ',', '.') ?></td>
                <?php
            } elseif ($columnas[$i] == "Impresiones") {
                ?>
                <td style="background-color: #E5E5E5;text-align: left"><?= number_format($total_imps, 0, ',', '.') ?></td>
                <?php
            } elseif ($columnas[$i] == "CTR") {
                ?>
                <td style="background-color: #E5E5E5;text-align: left"><?= number_format($total_ctr, 2, ',', '.') . "%" ?></td>
                <?php
            } else {
                ?>
