...
<form id="form_actualizar_datos_cuenta" action="/micuenta/actualizar_datos_cuenta" method="post">
    <table class="tabla" style="border-spacing: 5px;">
        ...
        <tr>
            ...
            <td>
                 <input type="text" class="txt_default" style="width: 218px !important;" id="fecha_nacimiento" name="fecha_nacimiento" value="<?
                 if($usuario->fecha_de_nacimiento === null || $usuario->fecha_de_nacimiento === ""){
                     echo('Ingrese su fecha de cumpleaños');
                 }else{echo ($usuario->fecha_de_nacimiento);} ?>" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <select name="pais" class="combo" style="width: 232px">
                    <?php
...
<script type="text/javascript">
    ...
    $.datepicker.setDefaults($.datepicker.regional['es']);
        ...
        <?php }else{ ?>
            ...
            $("#btn_actualizar_datos_cuenta").click( function(e){
                e.preventDefault();
