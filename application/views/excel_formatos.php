...
header("Content-Disposition: attachment; filename=\"MediaFem - Reporte por formato.xls\"");
...
foreach ($arr_tabla as $row) {
    ...
    if ($size != "Totales:") {
        ...
        $arr_sites[] = array('formato'=>$size, 'imps' => $imps);
    }
}
...
<table>
    <tr>
        <td colspan="2"><b>MediaFem - Reporte por formatos</b></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
