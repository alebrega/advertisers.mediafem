...
header("Content-Disposition: attachment; filename=\"MediaFem - Reporte por Pais.xls\"");
...
foreach ($arr_tabla as $row) {
    ...
    if ($pais != "Totales:") {
        ...
        $total_imps = $total_imps + $rImps;
        $arr_sites[] = array('pais'=>$pais, 'imps' => $imps);
    }
}
...
<table>
    <tr>
        <td colspan="2"><b>MediaFem - Reporte por pa&iacute;s</b></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
        <td style="background-color: #E5E5E5;border-top: 1px solid #000;border-bottom: 1px solid #000">Pa&iacute;s</td>
