...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // SITIOS ESPECIFICOS **************************************************
        $('#sitios_especificos').load('/campania/get_sites_for_publinotas/', function() {
        ...
        $('#btn_paso_3').click(function(e) {
            ...
            if (id_sitios == '') {
                $("#error_paso_3").html('Por favor seleccione al menos un sitio.');
                error = true;
            }
