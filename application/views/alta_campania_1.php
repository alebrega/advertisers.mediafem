...
<script type="text/javascript">
    ...
    $().ready(function(){
        ...
        $('#btn_paso_2').click(function(e){
            ...
            if( id_anunciante == 0 && $('#nuevo_anunciante').is(':hidden')){
                $("#error_anunciante").html('Por favor seleccione un anunciante para la campaña.').css("display", "inline");
                error = true;
            }else if( id_anunciante == 0 && $('#nuevo_anunciante').is(':visible')){
                $("#error_anunciante").html('Por favor coloque el nombre del anunciante y luego pulse el botón Crear.').css("display", "inline");
                error = true;
            }
...
<div id="pasos">
    ...
    <span class="div_paso_6">Resumen</span>
</div>
...
<div id="paso_6" style="display:none;">
    ...
    <div class="row">
        ...
        <input type="button" name="btn_finalizar" id="btn_finalizar" value="Finalizar" class="button_new superButton" />
