...
<h2 class="border_bottom">Pausar campa&ntilde;a.</h2>

<div class="row">
    Est&aacute;s a punto de pausar la campa&ntilde;a:
</div>
...
<div>
    ...
    <span id="loader_pausar" style="display: none;">
        <img style="display:none;" src="/images/ajax-loader.gif" height="10px" /> Pausando campa&ntilde;a, espere por favor...
    </span>

    <span id="error_pausar" style="display: none; color: red;"></span>

    <span id="ok_pausar" style="display: none; color: green;">
        Campa&ntilde;a pausada correctamente, espere...
    </span>
</div>