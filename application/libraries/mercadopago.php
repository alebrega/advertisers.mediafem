...
class mercadopago {
    ...
    function set($client_id, $client_secret) {
    ...
    public function get_payment_info($id) {
        ...
        $paymentInfo = $this->get($uriPrefix."/collections/notifications/" . $id . "?access_token=" . $accessToken);
        return $paymentInfo;
    }
    ...
    public function refund_payment($id) {
        ...
        $response = $this->put("/collections/" . $id . "?access_token=" . $accessToken, $refund_status);
        return $response;
    }
    ...
    public function cancel_payment($id) {
        ...
        $response = $this->put("/collections/" . $id . "?access_token=" . $accessToken, $cancel_status);
        return $response;
    }
    ...
    public function search_payment($filters, $offset = 0, $limit = 0) {
        ...
        $collectionResult = $this->get($uriPrefix."/collections/search?" . $filters . "&access_token=" . $accessToken);
    ...
    public function update_preference($id, $preference) {
        ...
        $preferenceResult = $this->put("/checkout/preferences/{$id}?access_token=" . $accessToken, $preference);
        return $preferenceResult;
    }
    ...
    public function get_preference($id) {
        ...
        $preferenceResult = $this->get("/checkout/preferences/{$id}?access_token=" . $accessToken);
        return $preferenceResult;
    }
    ...
    private static function getConnect($uri, $method, $contentType) {
        $connect = curl_init($this->API_BASE_URL . $uri);
    ...
    public function exec($method, $uri, $data, $contentType) {
    ...
    public static function get($uri, $contentType = "application/json") {
        return $this->exec("GET", $uri, null, $contentType);
    }
    ...
    public static function put($uri, $data, $contentType = "application/json") {
        return $this->exec("PUT", $uri, $data, $contentType);
    }
