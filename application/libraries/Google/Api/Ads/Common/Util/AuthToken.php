...
class AuthToken {
     ...
     */
    function __construct($email, $password, $service, $source, $accountType = NULL, $server = NULL, $captchaToken = NULL, $captchaResponse = NULL, $curlUtils = NULL) {
        $this->email = $email;
        $this->password = $password;
        $this->accountType = is_null($accountType) ? self::DEFAULT_ACCOUNT_TYPE : $accountType;
