    ...
    function Do_direct_payment_demo() {
        ...
        */
        ...
        $CCDetails = array(
            ...
            'acct' => '4937630113388643', // Required.  Credit card number.  No spaces or punctuation.  
            'expdate' => '092015', // Required.  Credit card expiration date.  Format is MMYYYY
            'cvv2' => '894', // Requirements determined by your PayPal account settings.  Security digits for credit card.
            'startdate' => '', // Month and year that Maestro or Solo card was issued.  MMYYYY
            'issuenumber' => ''       // Issue number of Maestro or Solo card.  Two numeric digits max.
        );
        
        $PayerInfo = array(
            'email' => 'sc@mediafem.com', // Email address of payer.
            'payerid' => '', // Unique PayPal customer ID for payer.
            'payerstatus' => '', // Status of payer.  Values are verified or unverified
            'business' => 'MediaFem Business'        // Payer's business name.
        );
